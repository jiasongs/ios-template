...
@interface PlusTabBarButton ()<UIActionSheetDelegate> {
 ...
 */
+ (id)plusButton {
    PlusTabBarButton *button = [[PlusTabBarButton alloc] init];
    UIImage *normalButtonImage = [UIImage imageNamed:@"tabbar_mine_selected"];
