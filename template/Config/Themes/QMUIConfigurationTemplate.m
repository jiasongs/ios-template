...
#pragma mark - Global Color
    ...
    QMUICMI.blueColor = UIColorMake(49, 189, 243);                              // UIColorBlue : 蓝色                                  // UIColorYellow : 黄色
...
#pragma mark - UIButton
    QMUICMI.buttonHighlightedAlpha = 0.8;                 // ButtonHighlightedAlpha : QMUIButton 在 highlighted 时的 alpha，不影响系统的 UIButton
...
#pragma mark - TextField & TextView
    ...
    QMUICMI.textFieldTextInsets = UIEdgeInsetsMake(0, 5, 0, 5);                 // TextFieldTextInsets : QMUITextField 的内边距，不影响 UITextField
...
//    QMUICMI.navBarBackgroundImage = [UIImageMake(@"navigationbar_background") resizableImageWithCapInsets:UIEdgeInsetsMake(0, 1, 0, 1) resizingMode:UIImageResizingModeStretch];  // NavBarBackgroundImage : UINavigationBar 的背景图，注意 navigationBar 的高度会受多个因素（是否全面屏、是否使用了 navigationItem.prompt、是否将 UISearchBar 作为 titleView）的影响，要检查各种情况是否都显示正常。
    ...
    QMUICMI.navBarBarTintColor = UIColorMakeWithHex(@"#333");                                           // NavBarBarTintColor : UINavigationBar.barTintColor，也即背景色
    ...
    QMUICMI.navBarBackIndicatorImage = [ [UIImage qmui_imageWithShape:QMUIImageShapeNavBack size:CGSizeMake(13, 21) tintColor:NavBarTintColor] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];                                     // NavBarBackIndicatorImage : 导航栏的返回按钮的图片，图片尺寸建议为(13, 21)，否则最终的图片位置无法与系统原生的位置保持一致
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarItemTitleColor = UIColorMakeWithHex(@"#000000");
    QMUICMI.tabBarItemTitleColorSelected = UIColorMakeWithHex(@"#000000");                     // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
...
#pragma mark - SearchBar
    ...
    searchBar.searchTextPositionAdjustment = UIOffsetMake(8, 0); // 偏移
    QMUICMI.searchBarTextFieldBackground = [UIColor clearColor];          // SearchBarTextFieldBackground : QMUISearchBar 里的文本框的背景颜色
    QMUICMI.searchBarTextFieldBorderColor = [UIColor clearColor];                                // SearchBarTextFieldBorderColor : QMUISearchBar 里的文本框的边框颜色
    QMUICMI.searchBarBottomBorderColor = [UIColor clearColor];                          // SearchBarBottomBorderColor : QMUISearchBar 底部分隔线颜色
    ...
    QMUICMI.searchBarSearchIconImage = [UIImageMake(@"icon_search") qmui_imageWithSpacingExtensionInsets:UIEdgeInsetsMake(0, 0, 0, 0)];                                     // SearchBarSearchIconImage : QMUISearchBar 里的放大镜 icon
    QMUICMI.searchBarClearIconImage = nil;                                      // SearchBarClearIconImage : QMUISearchBar 里的文本框输入文字时右边的清空按钮的图片
//    QMUICMI.searchBarTextFieldCornerRadius = 20;                               // SearchBarTextFieldCornerRadius : QMUISearchBar 里的文本框的圆角大小，-1 表示圆角大小为输入框高度的一半
    
#pragma mark - TableView / TableViewCell
    QMUICMI.tableViewCellNormalHeight = 44; // 高度为0，不适用aotu size
...
#pragma mark - TZImagePickerController
    TZImagePickerController *pickerAppearance = [TZImagePickerController appearance];
    pickerAppearance.maxImagesCount = 9;
    pickerAppearance.minImagesCount = 1;
    pickerAppearance.naviTitleColor = NavBarTitleColor;
    pickerAppearance.naviTitleFont = NavBarTitleFont;
    pickerAppearance.barItemTextColor = NavBarTitleColor;
    pickerAppearance.naviBgColor = NavBarTintColor;
 
#pragma mark - toast
    QMUIToastBackgroundView *toastBackAppearance = [QMUIToastBackgroundView appearance];
    toastBackAppearance.shouldBlurBackgroundView = YES;
    toastBackAppearance.styleColor = UIColorMakeWithRGBA(0, 0, 0, 0.8);
    toastBackAppearance.cornerRadius = 5.0;
    
    QMUIToastContentView *toastContentAppearance = [QMUIToastContentView appearance];
    toastContentAppearance.insets = UIEdgeInsetsMake(ScaleSize(9), 16, ScaleSize(12), 16);
    toastContentAppearance.customViewMarginBottom = 7;
    toastContentAppearance.textLabelMarginBottom = 0;
    toastContentAppearance.detailTextLabelMarginBottom = 0;
    toastContentAppearance.textLabelAttributes = @{NSFontAttributeName: UIFontBoldMake(15),NSForegroundColorAttributeName:UIColorMakeWithHex(@"#fff"), NSParagraphStyleAttributeName: [NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:ScaleSize(20) lineBreakMode:NSLineBreakByWordWrapping textAlignment:NSTextAlignmentCenter]};
    toastContentAppearance.detailTextLabelAttributes = @{NSFontAttributeName: UIFontBoldMake(12), NSParagraphStyleAttributeName: [NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:18 lineBreakMode:NSLineBreakByWordWrapping textAlignment:NSTextAlignmentCenter]};
    
#pragma mark - AlertController
    // alert
    QMUIAlertController *alertAppearance =  [QMUIAlertController appearance];
    alertAppearance.alertContentMargin = UIEdgeInsetsMake(5, 0, 5, 0);
    alertAppearance.alertContentMaximumWidth = SCREEN_WIDTH * 0.7;
    alertAppearance.alertSeparatorColor = UIColorMake(211, 211, 219);
    alertAppearance.alertContentCornerRadius = 7;
    alertAppearance.alertButtonHeight = 42;
    alertAppearance.alertHeaderBackgroundColor = UIColorMakeWithHex(@"#fff");
    alertAppearance.alertButtonBackgroundColor = UIColorMakeWithHex(@"#fff");
    alertAppearance.alertButtonHighlightBackgroundColor = UIColorMakeWithHex(@"#ececec");
    alertAppearance.alertHeaderInsets = UIEdgeInsetsMake(16, 16, ScaleSize(16), 16);
    alertAppearance.alertTitleMessageSpacing = ScaleSize(13);
    alertAppearance.alertTextFieldFont = UIFontMake(14);
    alertAppearance.alertTextFieldTextColor = UIColorBlack;
    alertAppearance.alertTextFieldBorderColor = UIColorMake(210, 210, 210);
    alertAppearance.alertTitleAttributes = @{NSForegroundColorAttributeName:UIColorBlack,NSFontAttributeName:UIFontBoldMake(16),NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]};
    alertAppearance.alertMessageAttributes = @{NSForegroundColorAttributeName:UIColorBlack,NSFontAttributeName:UIFontMake(15),NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:ScaleSize(20) lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]};
    alertAppearance.alertButtonAttributes = @{NSForegroundColorAttributeName:UIColorMakeWithHex(@"#fdd000"),NSFontAttributeName:UIFontMake(16),NSKernAttributeName:@(0)};
    alertAppearance.alertCancelButtonAttributes = @{NSForegroundColorAttributeName:UIColorMakeWithHex(@"#333"),NSFontAttributeName:UIFontBoldMake(15),NSKernAttributeName:@(0)};
    alertAppearance.alertButtonDisabledAttributes = @{NSForegroundColorAttributeName:UIColorMake(129, 129, 129),NSFontAttributeName:UIFontMake(15),NSKernAttributeName:@(0)};
    alertAppearance.alertDestructiveButtonAttributes = @{NSForegroundColorAttributeName:UIColorRed,NSFontAttributeName:UIFontMake(16),NSKernAttributeName:@(0)};
    
    // sheet
    alertAppearance.sheetHeaderInsets = UIEdgeInsetsMake(10, 10, 10, 10);
    alertAppearance.sheetContentMargin = UIEdgeInsetsMake(150, 10, 7, 10);
    alertAppearance.sheetCancelButtonMarginTop = 7;
    alertAppearance.sheetContentCornerRadius = 5;
    alertAppearance.sheetButtonHeight = 50;
    alertAppearance.sheetTitleAttributes = @{NSForegroundColorAttributeName:UIColorMake(143, 143, 143),NSFontAttributeName:UIFontBoldMake(14),NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]};
    alertAppearance.sheetMessageAttributes = @{NSForegroundColorAttributeName:UIColorMake(143, 143, 143),NSFontAttributeName:UIFontMake(13),NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]};
    alertAppearance.sheetButtonAttributes = @{NSForegroundColorAttributeName:UIColorMakeWithHex(@"#333"),NSFontAttributeName:UIFontMake(17),NSKernAttributeName:@(0)};
    alertAppearance.sheetCancelButtonAttributes = @{NSForegroundColorAttributeName:UIColorRed,NSFontAttributeName:UIFontBoldMake(16),NSKernAttributeName:@(0)};
    alertAppearance.sheetButtonDisabledAttributes = @{NSForegroundColorAttributeName:UIColorMake(129, 129, 129),NSFontAttributeName:UIFontMake(16),NSKernAttributeName:@(0)};
    alertAppearance.sheetDestructiveButtonAttributes = @{NSForegroundColorAttributeName:UIColorRed,NSFontAttributeName:UIFontBoldMake(20),NSKernAttributeName:@(0)};

#pragma mark - Others
    QMUICMI.hidesBottomBarWhenPushedInitially = YES;
